                                    ...
                                    <div className="invoice-content">
                                        <div className="row">
                                            <div className="col-lg-9 col-sm-9">
                                                {
                                                    self ?
                                                        <div className="ordr-date">
                                                            ...
                                                            Customer Name : {self.FIRSTNAME+''+self.LASTNAME}<br />
                                                            Customer Email : {self.EMAIL}<br />
                                                            Customer Phone : {self.PHONENO}<br />
                                            ...
                                            <div className="col-lg-3 col-sm-3  right-text">
                                                <div className="ordr-date">
                                                    <b>Booking Date :</b> <Moment format='MMMM Do YYYY'>{self.APPOINTMENTDATE}</Moment> , <Moment format='h:mm:ss a'>{self.APPOINTMENTDATE}</Moment>
                                                </div>
                                            </div>
                                                    ...
                                                    <div className="card-body-table">
                                                        <div className="table-responsive">
                                                            <table className="table ucp-table table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th style={{ width: 200 }} className="text-center">Parlour Name</th>
                                                                        <th style={{ width: 150 }} className="text-center">Service Name</th>
                                                                        <th style={{ width: 150 }} className="text-center">Discount</th>
                                                                ...
                                                                <tbody>
                                                                {
                                                                    ...
                                                                    self.ch_salon_order_service_lists.map((row,index)=>(
                                                                        <tr key={index}>
                                                                            <td className="text-center">{row.PARLOURNAME}</td>
                                                                            <td className="text-center">{row.SERVICENAME}</td>
                                                                            <td className="text-center">{row.DISCOUNTPRICE}</td>
