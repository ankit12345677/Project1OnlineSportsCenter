...
export default class Register extends Component {
    ...
    handleSubmit = async (event) => {
        ...
        const{ firstName, lastName, phoneNo, address,role, email, password } = this.state;
        let data = {
            firstName: firstName,
            lastName: lastName,
            phoneNo: phoneNo,
                                            ...
                                            <div className="card-body">
                                                <form>
                                                    ...
                                                    <div className="form-group">
                                                        ...
                                                        <input className="form-control py-3"  type="text" placeholder="Enter address" name="role" value={this.state.role} onChange={(e) => this.handleChangeUser(e)} />
                                                    </div>
                                                    <div className="form-group">
