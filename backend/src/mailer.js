...
export default {
            ...
            smtpTransport.sendMail(
              {
                ...
                to: email,
                subject: "SportsCenter: OTP for Verify Email",
                html:
                  "Dear user,<br><br> Thank you for registering with SportsCenter.<br> <br> <b> <strong>One Time OTP:</strong> " +
                  otp +
                  " </b><br> <br> This link will expire in 30sec. <br> This is a system generated mail. Please do not reply to this email ID.<br>Warm Regards,<br> Customer Care<br> SportsCenter",
                // html:
                //   "Hi <br>" +
                //   "Your One Time Password(OTP) for completing your registeration on SportsCenter is  " +
                //   otp +
                //   " .Please do not share OTP with anyone .<br> Best Regards, <br> Team SportsCenter",
              },
              function (error, info) {
                if (error) {
                  console.log(error);
                  return reject({
                    name: "SportsCenterException",
            ...
            smtpTransport.sendMail(
              {
                from: process.env.MAIL_FROM,
                to: email,
                subject: "SportsCenter: Online Shopping Center",
                html:
            ...
            smtpTransport.sendMail(
              {
                from: process.env.MAIL_FROM,
                to: email,
                subject: "SportsCenter: OTP Sent",
                html:
                  "Dear user,<br><br> Thank you for Reset Password with SportsCenter.<br> <br> <b> <strong>One Time OTP:</strong> " +
                  otp +
                  " </b><br> <br> This link will expire in 30sec. <br> This is a system generated mail. Please do not reply to this email ID.<br>Warm Regards,<br> Customer Care<br> SportsCenter",
                // html:
                //   "Hi <br>" +
            ...
            <thead>
              <tr>
                <th style="text-align:left;"><img style="max-width: 80px;height:70px"
                    src="https://grociproduct.s3.ap-south-1.amazonaws.com/favicon.png" width='80' alt="SportsCenter"></th>
    ...
    const htmlFooter = ` </tbody>
            <tfooter>
              ...
              <td colspan="2" style="font-size:14px;padding:2px;">
                <strong style="display:block;margin:0 0 10px 0;">Regards,</strong>Team SportsCenter<br><br>
                For any queries please contact us at: <b>sportscenter017@gmail.com</b>
              </td>
              </tr>
            </tfooter>
                ...
                smtpTransport.sendMail(
                  {
                    ...
                    to: user.email,
                    subject:
                      "Your SportsCenter Order Confirmation. Please share your feedback",
                    html: totalHtml,
                  },
                  function (error, info) {
                    if (error || (info && info.rejected.length)) {
  ...
  sendInvoiceForSeller: (body, addrdetails, orderNo, customer, email) => {
    ...
    const htmlFooter = `</tbody> <tfooter> <tr> <tr> <td style="height:50px;"></td> </tr> <td colspan="2" style="font-size:14px;padding:2px;"> <strong style="display:block;margin:0 0 10px 0;">Regards,</strong>Team SportsCenter<br><br> For any queries please contact us at: <b>sportscenter017@gmail.com</b> </td> </tr> </tfooter> </table> </body> </html>`;
    const totalHtml = htmlHeader + htmlFooter;
    return new Promise((resolve, reject) => {
      try {
        const query = {};
