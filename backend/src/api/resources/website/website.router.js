...
websiteRouter
  .route("/product/home-kitchen")
  .get(sanitize(), websiteController.getHomeKitchen);
websiteRouter
  .route("/product/men-fashion")
  .get(sanitize(), websiteController.getMenFashion);
websiteRouter
  .route("/product/women-fashion")
  .get(sanitize(), websiteController.getWomenFashion);
websiteRouter.route("/product/").get(sanitize(), websiteController.getMakeup);
websiteRouter
